...
def generate_customer_data(num_records):
 ...
 policy_number = fake.random_number(digits=5, fix_len=True)
        ...
        data.append([
            ...
            online_activity, service_calls, current_insurance, coverage, premium_3yrs
        ])
...
columns = [
    ...
    'Online Activity', 'Service Calls', 'Current Insurance', 'Coverage', 'Premium (3yrs)'
]
...
df.to_csv('fraud_testdata.csv', index=False)

print('fraud_testdata.csv file created successfully with', num_records, 'records')
